...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=2800&pause=900&color=36BCF7&center=true&vCenter=true&width=850&lines=Desarrollo+Web+Junior;Python+%7C+PHP+%7C+JavaScript+%7C+SQL;Aplicaciones+web+con+Flask+y+MySQL;Gestion+de+servicios+%2B+soluciones+digitales" alt="Animación de presentación" />
</p>
...
<table>
  <tr>
    <td width="58%" valign="top">
      <ul>
        <li>🎓 Soy <strong>Programadora y Desarrolladora Web Junior</strong>.</li>
        <li>💻 Actualmente estoy reforzando <strong>desarrollo web, programación orientada a objetos y bases de datos relacionales</strong>.</li>
        <li>🧩 Vengo del mundo de la gestión de servicios, operaciones, RR. HH. y atención al cliente.</li>
        <li>🚀 Me interesa crear soluciones útiles, claras y orientadas a mejorar procesos reales.</li>
        <li>📍 Vivo en A Coruña y busco oportunidades como desarrolladora web junior o programadora junior.</li>
      </ul>
    </td>
...
- Panel de estadísticas con métricas de soporte y control de SLA.
- Historial de comentarios, cambios de estado y notificaciones.
- Recuperación de contraseña y configuración de correo.
- Manual técnico y manual de usuario incluidos.

📁 [Ver carpeta del proyecto Helpdesk](./Helpdesk)
